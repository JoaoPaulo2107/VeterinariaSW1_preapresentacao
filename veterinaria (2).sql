...
('golden', 'rex', 22, 2, 'Macho', 'Cachorro', 15.00, '', 1);
...
INSERT INTO `consulta` (`ID_consulta`, `Data_consulta`, `Procedimento`, `Horario`, `Observacao`, `ID_Animal`, `ID_veterinario`, `Status`, `motivo_cancelamento`) VALUES
(2, '2024-01-16', 'Check-up', '14:00', 'Consulta de rotina', 2, 2, 'Aceita', NULL),
(3, '2025-11-30', 'Vacinação', '16', '', 4, NULL, 'Recusada', 'sadsada'),
(4, '2025-11-24', 'Vacinação', '11:00', '', 22, NULL, 'Aceita', 'sdfsdf'),
(5, '2025-11-12', 'Banho e tosa', '16:00', '', 6, NULL, 'Pendente', 'dfsfsf'),
(6, '2025-11-26', 'Vacinação', '10:00', '', 4, NULL, 'Pendente', NULL),
(7, '2025-12-10', 'Retorno', '16:00', '', 10, NULL, '', 'fxdgfsdgd'),
(8, '2025-11-30', 'Vacinação', '16:00', 'brabo', 22, NULL, 'Pendente', NULL);
...
(2, '67890-SP', 'Dra. Ana', 'ana@vet.com', '(11) 97777-6665', 'Cirurgia', '09:00-18:00', NULL, '1990-08-15', '555.666.777-88'),
(6, '67890-SP', 'DR carlos', 'carlos@vet.com', '(11) 98888-7777', 'Clínico Geral', NULL, 'Masculino', '2025-11-12', '555.666.777-88');
...
ALTER TABLE `consulta`
  ...
  ADD CONSTRAINT `fk_consulta_funcionario` FOREIGN KEY (`ID_veterinario`) REFERENCES `funcionario` (`ID_veterinario`) ON DELETE SET NULL;
COMMIT;
